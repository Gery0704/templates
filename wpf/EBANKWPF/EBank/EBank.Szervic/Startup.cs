...
namespace EBank.Szervic
{
    public class Startup
    {
        ...
        {// Dependency injection beállítása az adatbázis kontextushoz
            ...
            services.AddIdentity<Clients, IdentityRole<int>>()
                .AddEntityFrameworkStores<EBankContext>() // EF használata a TravelAgencyContext entitás kontextussal
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IServiceProvider serviceProvider)
        {
            ...
            var userManager = serviceProvider.GetRequiredService<UserManager<Clients>>();
